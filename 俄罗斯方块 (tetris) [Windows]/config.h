...
constexpr double DAS=0.1; //自动移动延迟，单位 秒
constexpr double ARR=0.022; //自动重复速率，单位 秒/列
...
constexpr int Model=0; //0:ZEN；1:40-lines；2:Blitz
constexpr int lim_line=40; //竞速行数
constexpr double lim_time=120; //闪电战时间，单位 秒
...
constexpr double time_interval=1; //垃圾行增加速率
